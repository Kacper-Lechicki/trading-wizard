...
Each morning you tell the chat your budget and market preference. The system screens for movers, enriches them with technicals and news from multiple sources, and runs AI analysis to produce ranked signals with exact entry, exit, and stop-loss levels. You trade through your own broker, then log results back into the chat. Weekly, the system reviews your performance and generates insights that feed into all future scans - so recommendations sharpen over time.

_Want to understand the full picture?_ **[How It Works →](docs/HOW_IT_WORKS.md)**
...
| News (source 2) | Finnhub (supplementary)   | Free         |
...
You need Docker and a few free API keys (OpenRouter, FMP, optionally Finnhub). The full setup takes about 15 minutes - from clone to your first market scan.
...
- **[Setup Guide](docs/SETUP_GUIDE.md)** - install and configure from scratch
- **[How It Works](docs/HOW_IT_WORKS.md)** - understand the system end to end
- **[Blueprint](docs/BLUEPRINT.md)** - full technical reference
